	...
	*/
	function render(){
        if (empty($this->value) || !is_array($this->value)) {
            $this->value = array(
                array(
                    'group_title' => __('New', MTS_THEME_TEXTDOMAIN ).' '.$this->field['groupname'],
                    'group_sort' => '0',
                )
            );
        }
        ...
        $field_is_title = true;
            ...
            echo '</table>';
            echo '<a href="javascript:void(0);" class="button button-secondary nhp-opts-groups-close">' . __('OK', MTS_THEME_TEXTDOMAIN ). '</a>';
            echo '<a href="javascript:void(0);" class="button deletion nhp-opts-groups-remove">' . __('Delete', MTS_THEME_TEXTDOMAIN ).' '. $this->field['groupname']. '</a>';
            echo '</div></div>';
        ...
        foreach ($groups as $k => $group) {
            ...
            //echo '<h4>' . __('Group Title', MTS_THEME_TEXTDOMAIN ) . '</h4>';
        ...
        echo '</div><a href="javascript:void(0);" class="button nhp-opts-groups-add button-secondary" rel-id="' . $this->field['id'] . '-ul" rel-name="' . $this->parent->args['opt_name'] . '[' . $this->field['id'] . '][group_title][]">' . __('Add', MTS_THEME_TEXTDOMAIN ) .' '.$this->field['groupname']. '</a><br/>';
