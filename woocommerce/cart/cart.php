						...
						<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
							...
							<td class="product-remove">
								...
								echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
									...
									__( 'Remove this item', MTS_THEME_TEXTDOMAIN ),
									esc_attr( $product_id ),
							...
							<td class="product-data">
								<?php
									...
									if ( ! $_product->is_visible() )
										echo apply_filters( 'woocommerce_cart_item_name', $name, $cart_item, $cart_item_key ) . '&nbsp;';
									else
										echo apply_filters( 'woocommerce_cart_item_name', sprintf( '<a href="%s">%s</a>', $_product->get_permalink( $cart_item ), $name ), $cart_item, $cart_item_key );
									echo '</div>';
									// Meta data
