...
<ul id="checkout-progress" class="clearfix">
	<li><a href="<?php echo esc_url( $woocommerce->cart->get_cart_url() ) ?>"><span class="step-title"><?php _e( 'Shopping Cart', MTS_THEME_TEXTDOMAIN ); ?></span><span class="items"><?php echo $woocommerce->cart->cart_contents_count; ?></span></a><span class="icon"><i class="fa fa-angle-right"></i></span></li>
