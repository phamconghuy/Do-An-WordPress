	...
	<div class="browse-our-categories home-section clearfix">
		...
		<?php if ( !empty( $browse_heading ) ) { ?>
			<div class="featured-category-title">
				...
				<div class="readMore">
					<a href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>" rel="nofollow"><?php _e('View All', MTS_THEME_TEXTDOMAIN ); ?></a>
				</div>
